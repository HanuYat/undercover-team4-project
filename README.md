...
- **구현** — 여러 명이 한 대상을 함께 끌 수 있는 밧줄 연행 시스템 — 연결 동기화 · 무게 페널티 · 장력 · 배치
- **배경** — 수갑 검거는 회수 규칙이 복잡했고 협동이 발생하지 않아, 팀 회의를 거쳐 기본 검거 수단을 수갑에서 밧줄로 변경하였습니다.
...
- **배경** — 검거 보상이 개인 단위로 쌓여 협동할 이유가 없었고, 라운드가 끝나면 함께 사라져 유지되는 개념이 없었습니다.
