...
public struct LobbyPlayerEntry : INetworkSerializable, IEquatable<LobbyPlayerEntry>
{
    ...
    /// <summary>로봇 색 (#432) — <see cref="PlayerColorPalette"/> 인덱스. 순수 코스메틱이라 서버가 검증하지 않는다.</summary>
    ...
    // OnListChanged도 일어나지 않는다. 행 매칭은 SessionRoster가 ClientId를 직접 비교하므로(중복 보고 흡수)
