...
/// <summary>
/// NpcController의 오검거 페널티 파트 (#277/#278/#279) — 수용·추격·호송의 튜닝 필드와 전이 API.
/// 본체(NpcController.cs)가 커져 도메인별 partial로 분리했다 — 클래스는 하나이므로
/// 직렬화·프리팹·상태 클래스의 owner 참조는 그대로다. 이동만 했고 동작 변화는 없다.
