...
public partial class NpcController
{
    ...
    /// <summary>이번 이송이 질주인지 — 출구 탈출(#310)은 도주 배속으로 달린다. NpcHoldingState가 읽는다. 서버에서만 유효.</summary>
    ...
    /// sprint=true면 도주 배속으로 달린다 — 이탈 NPC의 출구 탈출(#310)용, 판정 후 이송은 걷는다.
    /// </summary>
    public void SendToHolding(Transform spot, bool sprint = false)
    {
