...
/// <summary>
/// NPC 근접 공격음 (#817) — 주먹을 휘두를 때와 실제로 맞혔을 때 각각 3D로 한 번 낸다.
///
...
///
/// <b>스윙음은 늦춰서 낸다.</b> 스윙 이벤트는 모션 시작에 오는데 주먹이 닿는 것은 변형에 따라
...
{
    [Tooltip("주먹이 닿기 이만큼(초) 전에 스윙음을 낸다 — 휙 소리가 타격음으로 이어지게 하는 값. " +
