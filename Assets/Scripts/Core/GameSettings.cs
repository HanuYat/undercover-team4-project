...
public static class GameSettings
{
    ...
    /// <summary>
    /// 저장된 값을 읽어 적용한다. 플레이 시작마다 자동 실행 — 세 필드를 무조건 덮어쓰므로
    ...
    /// <summary>세 값을 기본값으로 되돌린다 — 설정 창의 [기본값 복원].</summary>
    ...
    /// (setter의 SetFloat은 메모리까지다. 슬라이더를 끌 때마다 여기까지 오면 드래그 내내 디스크를 쓴다)
    /// </summary>
