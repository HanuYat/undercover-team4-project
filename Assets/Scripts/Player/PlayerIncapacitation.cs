...
public enum IncapacitationCause
{
    ...
    Die, // HP 0 기능 정지 (#364, #524) — 현장 구조로는 못 일어난다. 복구는 동료의 부활 키트(#613)
...
///  · Die — HP 0으로 곧바로 들어간다(#524). 현장 구조 채널링으로는 못 일어나고 동료가 부활 키트를
///    써야 한다(#613). 조준 히트박스는 켜되(키트·운반 조준용) 구조 채널링은 거부된다.
