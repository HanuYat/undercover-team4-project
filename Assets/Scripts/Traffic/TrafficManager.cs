...
///
/// <b>간격은 맵 전체 하나다</b> (#673) — <see cref="m_spawnIntervalSeconds"/>마다 레인을 랜덤으로
/// 뽑아 거기서만 낸다. 레인별 간격이던 시절엔 레인이 8개라 레인당 40초여도 맵 어딘가에선 5초마다
/// 나왔다. 한 차례의 대수(<see cref="m_vehiclesPerSpawnMin"/>)는 따로 잡는다 — 총량이 같아도
/// 대수를 늘리는 쪽이 몰렸다 잠잠해져 도시처럼 보인다.
///
/// 레인별 하한(건널 창 보장)은 남아 같은 레인이 연달아 뽑히는 것만 거른다.
///
