...
시체 1구·원격 1인 기준 **2.1 KB/s**([선행 계획서 §1-6](728-ragdoll-pose-streaming.md), 25Hz ·
페이로드 86B · 자세 뼈 17개 — 2026-09-02 재측정. 그 전에는 62B·1.5KB/s로 적혀 있었다). 플레이어는 **동시 시체가 최대 6구**로 상한이 명확하고, 정착하면 스트림이 끊기므로
