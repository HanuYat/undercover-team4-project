...
> **[대체됨 — 2026-08-05]** 이 문서의 partial 분리는 #259로 **완료됐다**(현재 12파일 1,830줄). 다음 단계인 부품 컴포넌트
> 분리 계획은 [npccontroller-component-split-plan.md](npccontroller-component-split-plan.md)(#503)에 있고, 아래 § 1의
> "컴포넌트 분리 비추천" 판단은 그 문서 § 2의 실측으로 **뒤집혔다** — 경로 변경은 상태 클래스 76건 + partial 간 12건이다.
